...
describe('npv', () => {
	it('Must be close to -7.67 (excel)', () => {
	...
	it('Must be close to 808.41 (excel)', () => {
		expect(
			npv([
	...
	it('Must be close to 47.39 (excel)', () => {
	...
	it('Must be close to -98.24 (excel)', () => {
	...
	it('Must be close to 1307.29 (excel)', () => {
	...
	it('Must be close to 1922.06 (excel)', () => {
	...
	it('Must be close to -3749.47 (excel)', () => {
		expect(
